 ...
 *
 * Set 'blacklist_tables' according to 'blacklist'.
 *
 * If 'dryrun' is true, the function only attempts to parse
 * 'blacklist' without actually changing the 'blacklist table'.
 *
